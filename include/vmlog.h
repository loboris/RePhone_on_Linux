...
extern void _log_printf(int type, const char *file, int line, const char *msg, ...);
...
#define vm_log_fatal(...)		_log_printf(1,__FILE__, __LINE__,__VA_ARGS__)
...
#define vm_log_error(...)		_log_printf(2,__FILE__, __LINE__,__VA_ARGS__)
...
#define vm_log_warn(...)		_log_printf(3,__FILE__, __LINE__,__VA_ARGS__)
...
#define vm_log_info(...)		_log_printf(4,__FILE__, __LINE__,__VA_ARGS__)
...
#define vm_log_debug(...)		_log_printf(5,__FILE__, __LINE__,__VA_ARGS__)
#endif
