...
#define VM_PIN_P0 3       /* Pin mux, VM_DCL_PIN_MODE_GPIO / VM_DCL_PIN_MODE_PWM */
#define VM_PIN_P1 27      /* Pin mux, VM_DCL_PIN_MODE_GPIO / VM_DCL_PIN_MODE_SPI */
#define VM_PIN_P2 28      /* Pin mux, VM_DCL_PIN_MODE_GPIO / VM_DCL_PIN_MODE_SPI */
#define VM_PIN_P3 29      /* Pin mux, VM_DCL_PIN_MODE_GPIO / VM_DCL_PIN_MODE_SPI */
#define VM_PIN_P4 19      /* Pin mux, VM_DCL_PIN_MODE_GPIO / VM_DCL_PIN_MODE_SPI */
#define VM_PIN_P5 43      /* Pin mux, VM_DCL_PIN_MODE_GPIO / VM_DCL_PIN_MODE_I2C */
#define VM_PIN_P6 44      /* Pin mux, VM_DCL_PIN_MODE_GPIO / VM_DCL_PIN_MODE_I2C */
#define VM_PIN_P7 10      /* Pin mux, VM_DCL_PIN_MODE_GPIO / VM_DCL_PIN_MODE_UART */
#define VM_PIN_P8 11      /* Pin mux, VM_DCL_PIN_MODE_GPIO / VM_DCL_PIN_MODE_UART */
#define VM_PIN_P9 1       /* Pin mux, VM_DCL_PIN_MODE_GPIO / VM_DCL_PIN_MODE_EINT / VM_DCL_PIN_MODE_ADC */
#define VM_PIN_P10 2      /* Pin mux, VM_DCL_PIN_MODE_GPIO / VM_DCL_PIN_MODE_EINT / VM_DCL_PIN_MODE_ADC */
#define VM_PIN_P11 52     /* Pin mux, VM_DCL_PIN_MODE_EINT */
#define VM_PIN_P12 17     /* Pin mux, VM_DCL_PIN_MODE_GPIO */
#define VM_PIN_P13 15     /* Pin mux, VM_DCL_PIN_MODE_GPIO */
#define VM_PIN_P14 12     /* Pin mux, VM_DCL_PIN_MODE_GPIO */
#else
#define VM_PIN_P0 0
#endif
