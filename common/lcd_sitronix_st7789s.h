...
#define LCD_SET_SERIAL0_IF_SIZE(n)                              \
...
#define LCD_SET_LCD_ROI_CTRL_OUTPUT_FORMAT(n)           \
    REG_LCD_ROI_CTRL &= ~LCD_ROI_CTRL_DATA_FORMAT_MASK; \
    REG_LCD_ROI_CTRL |= n;

#define SET_LCD_SERIAL0_IF_2PIN_SIZE(n)                                      \
    REG_LCD_SIF_PIX_CON_REG &= ~(LCD_SERIAL_PIX_CONFIG_SIF0_2PIN_SIZE_MASK); \
    REG_LCD_SIF_PIX_CON_REG |=                                               \
        ((n & LCD_SERIAL_PIX_CONFIG_SIF0_2PIN_SIZE_MASK) << LCD_SERIAL_PIX_CONFIG_SIF0_2PIN_SIZE_OFFSET)
